...
```mdx
<Callout type="info" title="정보">유용한 정보를 전달합니다.</Callout>
<Callout type="warn" title="주의">주의가 필요한 사항입니다.</Callout>
<Callout type="error" title="오류">오류 또는 위험한 상황입니다.</Callout>
<Callout type="success" title="성공">성공적으로 완료되었습니다.</Callout>
```
...
<Button href="/docs/guide" variant="solid">시작하기</Button>
```

<Button href="/docs">문서 보기</Button> <Button href="https://github.com">GitHub</Button> <Button href="/docs/guide" variant="solid">시작하기</Button>
