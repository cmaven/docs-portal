---
title: 컴포넌트 가이드
description: MDX 문서에서 사용할 수 있는 UI 컴포넌트 모음
---

Tech Docs Portal은 다양한 UI 컴포넌트를 **import 없이** MDX 파일에서 바로 사용할 수 있습니다.
...
<Steps>
  ...
  <Step>
    ...
    `content/docs/` 디렉토리에 MDX 파일을 추가합니다.
  </Step>
</Steps>
```
...
모든 컴포넌트는 **import 없이** MDX 파일에서 바로 사용할 수 있습니다.
